    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddAuthentication("MyCookieAuth").AddCookie("MyCookieAuth", options =>
            {
                ...
                options.LoginPath = "/Account/Login"; //by default, if you are not authorized sends you back to loginpage, <= that declares explicity the redirect page if you hit a page with denied access.
